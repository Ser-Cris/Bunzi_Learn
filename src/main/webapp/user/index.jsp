...
<main>
    <div class="container ">
        ...
        <section class="hero is-small" style="background-color: #CDFFDA;">
            <div class="hero-body">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="card " style="width: 20rem;">
                <img src="../assets/img/bonzi.gif" class="card-img-top" alt="...">
                <div class="card-body ">
                    <p class="card-text">Bonzi.</p>
                </div>
            </div>
            <div class="card" style="width: 20rem; border-color: #FFFFFF;">
            ...
            <div class="card" style="width: 20rem;">
                ...
                <div class="card-body">
                    <p class="card-text">Jose Emiliano Zuñiga Hernandez.</p>
                </div>
            </div>
        </div>
    </div>
