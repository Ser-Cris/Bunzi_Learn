...
<div id="modal-js-example2" class="modal">
    ...
    <div class="modal-content">
        <div class="box">
            ...
            <footer class="modal-card-foot">
                <a href="index.jsp" class="button is-success is-fullwidth js-modal-trigger" data-target="modal2">Continuar</a>
            </footer>
            <!-- Your content -->
        </div>
    </div>
        ...
        <div class="tile is-ancestor">
            <div class="tile is-vertical is-8">
                ...
                <div class="tile is-parent">
                    <article class="tile is-child notification is-success is-light">
                        <h2 class="h2 has-text-centered has-text-weight-semibold">
                            Tu curso comenzará en 2hrs, 3min, 8seg
                        </h2>
                    </article>
                </div>
            </div>
